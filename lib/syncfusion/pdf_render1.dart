...
class PdfRender1 extends StatefulWidget {
  @override
  _PdfRender1State createState() => _PdfRender1State();
}

class _PdfRender1State extends State<PdfRender1> {
  bool _showPdf = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _showPdf ? _buildPdfViewer() : _buildGeneratePdf(),
    );
  }
  ...
  Future<void> generateInvoice() async {
    font = PdfTrueTypeFont(await _readData('NotoSans-Regular.ttf'), 12);
  ...
  PdfLayoutResult drawHeader(PdfPage page, Size pageSize, PdfGrid grid) {
    ...
    // page.graphics.drawString(
    //       'こんにちは世界/你好，世界/안녕, 세상.', PdfCjkStandardFont(PdfCjkFontFamily.heiseiMinchoW3, 30),
    //       brush: PdfBrushes.white,
    //       bounds: Rect.fromLTWH(25, 0, pageSize.width - 115, 90),
    //       format: PdfStringFormat(lineAlignment: PdfVerticalAlignment.middle));
  ...
  Future<PdfFont> getFont() async {
    PdfFont font = PdfTrueTypeFont(await _readData('NotoSans-Regular.ttf'), 12);
    return font;
